...
export const CashbackAccountInfo = ({ data, order,finance }: any) => {
  ...
  const transactionOptions = transactionTypes.map((type: IDate) => ({
    value: type.value,
    label: type.name,
  }));
  ...
  const filteredCashBack = order?.filter((item: any) => {
      ...
      <div className="lk__balance-info">
        ...
        <div className="lk__balance-info__balance-block">
          <span className="lk__balance-info__balance-price">
            {finance?.availableRewardAccount ? finance?.availableRewardAccount : 0} Р
          </span>
          <span className="lk__balance-info__balance-price-sub">
            {finance?.availableRewardAccountUe ? finance?.availableRewardAccountUe : 0} УЕ
          </span>
        </div>
      </div>
      ...
      <div className="lk__info-table">
        <div className="lk__table-wrapper">
          <table className="lk__table">
            ...
            <tbody>
              {filteredCashBack?.map((item: any, index: any) => {
                return (

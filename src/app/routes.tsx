...
} from './personal-account/data/constants'
...
import { EditPayments } from './personal-account/personal-account-finance/payments-tabs/payments-edit'
import PersonalAccountSystem from './personal-account/personal-account-business/personal-account-system'
import PersonalAccountOrders from './personal-account/personal-account-my-orders/personal-account-orders'
  ...
  return (
    <Routes>
      ...
      <Route path={appRoutes.PERSONAL_ACCOUNT} element={<PersonalAccount />}>
        ...
        />
        <Route
          path={personalAccountRoutes.SYSTEM}
          element={<PersonalAccountSystem />}
        />
        <Route
          path={personalAccountRoutes.MY_ORDERS}
          element={<PersonalAccountOrders />}
        />
        <Route
        ...
        />
        <Route
          path={'finance/' + financeAccountRoutes.FINANCE_BALANCE}
          element={<PersonalAccountBalance />}
        />
        <Route
          path={'finance/' + financeAccountRoutes.FINANCE_TRANSACTIONS}
          element={<PersonalAccountTransactions />}
        />
        <Route
          path={'finance/' + financeAccountRoutes.FINANCE_PAYMENTS}
          element={<PersonalAccountPayments />}
        />
        <Route
          path={financeAccountRoutes.FINANCE_PAYMENTS_EDIT}
